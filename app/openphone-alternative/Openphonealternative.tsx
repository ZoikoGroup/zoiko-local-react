...
import { FiCheck, FiGlobe, FiActivity, FiVideo, FiPlus, FiMinus } from "react-icons/fi";

const fitChecklist = [
    "You need local presence in international markets, not just North America",
    "You want an AI Receptionist for after-hours and overflow",
    "You're a cross-border or diaspora-led business",
    "You want video and numbers in the same workspace"
];
const idealFor = [
    "You need local presence in international markets, not just North America",
    "You want an AI Receptionist for after-hours and overflow",
...
const portingFaqs = [
    ...
    {
        question: "Can I use it for a distributed team?",
        answer:
            "Yes. Zoiko Local supports distributed and remote teams with shared business numbers, routing, collaboration features, and centralized communication management.",
    },
    {
        question: "Can I get numbers outside North America?",
        answer:
            "Yes. Subject to availability, regulations, carrier support, and eligibility requirements, businesses can acquire and manage local numbers across multiple supported countries and regions.",
    },
];
export default function Openphonealternative() {
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div>
                            ...
                            <p className="mt-8 max-w-xl text-[17px] leading-8 text-[#666666] dark:text-gray-400">
                                If your business needs local numbers across countries, team routing, and an AI Receptionist, Zoiko Local is worth a look. Sound local. Reach anywhere.
                            </p>
            ...
            <section className="bg-[#F7F5F2] dark:bg-slate-900 py-10 md:py-14">
                <div className="max-w-6xl mx-auto px-5">
                    ...
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        <h2 className="mt-5 text-2xl sm:text-3xl md:text-[48px] leading-[1.15] font-bold dark:text-white">
                        ...
                        <p className="mt-7 max-w-3xl mx-auto text-[16px] leading-8 text-[#666666] dark:text-gray-400">
                            OpenPhone is a capable product. Zoiko Local is built for a specific need: businesses that want a trusted local presence across markets, with calling, video, and an AI Receptionist in one workspace. Here's where it fits best.
                        </p>
                    </div>
                ...
                <div className="max-w-5xl mx-auto px-5">
                    ...
                    <div className="text-center">
                        ...
                        <h2 className="mt-5 text-3xl md:text-[50px] font-bold leading-tight text-[#123533] dark:text-white">
                            OpenPhone vs Zoiko Local, answered.
                        </h2>
                    </div>
                    ...
                    <div className="mt-10 rounded-xl border-l-4 border-[#EB643F] border border-[#EB643F] dark:border-[#EB643F] bg-white dark:bg-slate-800 px-6 py-5">
                        <p className="text-sm leading-7 text-gray-500 dark:text-gray-400">
                            OpenPhone and its logo are trademarks of their respective owner. Zoiko Local is not affiliated with, endorsed by, or sponsored by OpenPhone. Comparisons reflect general product positioning; review each provider's current features and terms before deciding.
                        </p>
                    </div>
