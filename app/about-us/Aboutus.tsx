...
const icons: Record<string, (props: { className?: string; light?: boolean }) => ReactNode> = {
  phone: ({ className = "h-6 w-6", light }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={light ? "white" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.79 19.79 0 0 1 2.12 4.18 2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" />
    </svg>
  ),
  routing: ({ className = "h-6 w-6", light }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={light ? "white" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M16 3h5v5" /><path d="M8 3H3v5" /><path d="M21 3l-8.5 8.5" /><path d="M3 3l8.5 8.5" /><path d="M3 21l8.5-8.5" /><path d="M21 21l-8.5-8.5" />
    </svg>
  ),
  voicemail: ({ className = "h-6 w-6", light }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={light ? "white" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="6" cy="12" r="4" /><circle cx="18" cy="12" r="4" /><line x1="6" y1="16" x2="18" y2="16" />
    </svg>
  ),
  sparkle: ({ className = "h-6 w-6", light }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={light ? "white" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2l2.4 7.2L22 12l-7.6 2.8L12 22l-2.4-7.2L2 12l7.6-2.8z" />
    </svg>
  ),
  video: ({ className = "h-6 w-6", light }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={light ? "white" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <rect x="2" y="5" width="14" height="14" rx="2" /><path d="M16 10l5-3v10l-5-3" />
    </svg>
  ),
  sliders: ({ className = "h-6 w-6", light }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={light ? "white" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <line x1="4" y1="21" x2="4" y2="14" /><line x1="4" y1="10" x2="4" y2="3" /><line x1="12" y1="21" x2="12" y2="12" /><line x1="12" y1="8" x2="12" y2="3" /><line x1="20" y1="21" x2="20" y2="16" /><line x1="20" y1="12" x2="20" y2="3" /><line x1="1" y1="14" x2="7" y2="14" /><line x1="9" y1="8" x2="15" y2="8" /><line x1="17" y1="16" x2="23" y2="16" />
    </svg>
  ),
  globe: ({ className = "h-6 w-6", light }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={light ? "white" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  shield: ({ className = "h-6 w-6", light }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={light ? "white" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><path d="M9 12l2 2 4-4" />
    </svg>
  ),
  lock: ({ className = "h-6 w-6", light }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={light ? "white" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <rect x="3" y="11" width="18" height="11" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" />
    </svg>
  ),
  eye: ({ className = "h-6 w-6", light }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={light ? "white" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8S1 12 1 12z" /><circle cx="12" cy="12" r="3" />
    </svg>
  ),
  undo: ({ className = "h-6 w-6", light }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={light ? "white" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 7v6h6" /><path d="M3 13a9 9 0 1 0 3-7.7L3 7" />
    </svg>
  ),
  clipboard: ({ className = "h-6 w-6", light }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={light ? "white" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  target: ({ className = "h-6 w-6", light }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={light ? "white" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="6" /><circle cx="12" cy="12" r="2" />
    </svg>
  ),
  server: ({ className = "h-6 w-6", light }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={light ? "white" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <rect x="2" y="2" width="20" height="8" rx="2" /><rect x="2" y="14" width="20" height="8" rx="2" /><line x1="6" y1="6" x2="6.01" y2="6" /><line x1="6" y1="18" x2="6.01" y2="18" />
    </svg>
  ),
  trendingUp: ({ className = "h-6 w-6", light }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={light ? "white" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  split: ({ className = "h-5 w-5" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M16 3h5v5" /><path d="M3 16v5h5" /><path d="M21 3l-8 8" /><path d="M3 21l8-8" />
    </svg>
  ),
  ...
  fingerprint: ({ className = "h-5 w-5" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 12a10 10 0 0 1 18-6" /><path d="M5 19.5A10 10 0 0 0 22 12" /><path d="M6.7 6.7a6 6 0 0 1 10.6 4" /><path d="M8 16a6 6 0 0 0 9.3-4" /><circle cx="12" cy="12" r="2" />
    </svg>
  ),
...
function Icon({
  ...
  if (wrapperClassName) {
    return <span className={wrapperClassName}>{render({ className, light })}</span>;
  }
  return <>{render({ className, light })}</>;
}

// ─── ICON BADGE (the 44×44 rounded icon boxes) ──────────────────────────────
function IconBadge({ name, light = false }: { name: string; light?: boolean }) {
  return (
    <span
      className={`inline-flex h-11 w-11 items-center justify-center rounded-xl ${
        light ? "bg-white/10" : "bg-[#163a2e]/10 dark:bg-[#34d39e]/10"
      }`}
    >
      <Icon
        name={name}
...
// ─── DATA ────────────────────────────────────────────────────────────────────
const trustPoints = [
  { icon: "shield", title: "Trust", desc: "Verified local presence customers recognise and answer with confidence." },
  { icon: "checkCircle", title: "Reliability", desc: "Calls, forwarding and messaging that work the same way every time." },
  { icon: "globe", title: "Cross-border identity", desc: "One identity that stays consistent wherever you operate." },
];

const features = [
  { icon: "phone", title: "Local numbers", desc: "Get a real local number in the markets that matter to you." },
  { icon: "routing", title: "Calling & forwarding", desc: "Route calls to any device, anywhere, with smart rules." },
  { icon: "voicemail", title: "Voicemail intelligence", desc: "Transcribed, summarised and searchable voicemail." },
  { icon: "sparkle", title: "AI receptionist", desc: "Greet, qualify and route callers automatically." },
  { icon: "video", title: "Video calling", desc: "Move from a call to face-to-face in a single tap." },
  { icon: "sliders", title: "Business controls", desc: "Manage lines, teams and permissions from one place." },
];

const pillars = [
  { icon: "globe", title: "Access", desc: "Open local presence in new markets in minutes, not weeks." },
  { icon: "shield", title: "Trust", desc: "Verified, recognisable numbers people actually pick up." },
  { icon: "lock", title: "Control", desc: "Full visibility and governance across every line." },
];

const businessCards = [
  { icon: "plus", title: "Introduce a local line", desc: "Add a local number without changing carriers." },
  { icon: "split", title: "Separate work & life", desc: "Keep business calls off your personal phone." },
  { icon: "users", title: "Consistent professionalism", desc: "One number your whole team can answer." },
  { icon: "mapPin", title: "One business, many regions", desc: "Present locally in every market you serve." },
  { icon: "wifi", title: "Remote-ready & flexible", desc: "Work from anywhere, sound like you're next door." },
  { icon: "heart", title: "Healthcare & care teams", desc: "Reliable, private lines for sensitive work." },
  { icon: "briefcase", title: "Personal & business split", desc: "Clear boundaries between the two." },
  { icon: "globe", title: "Cross-border operations", desc: "Compliant local numbers across borders." },
];
...
const aiGovern = [
  { icon: "eye", title: "Content review", desc: "AI suggestions are reviewed against clear, human-set rules." },
  { icon: "undo", title: "Reversible", desc: "Every automated action can be undone or overridden." },
  { icon: "clipboard", title: "Auditable", desc: "A complete record of what happened, when and why." },
];

const scaleItems = [
  { icon: "fingerprint", title: "Identity verification", desc: "Know who is on every line before it goes live." },
  { icon: "fileCheck", title: "Compliance by region", desc: "Rules applied automatically per jurisdiction." },
  { icon: "alertTriangle", title: "Fraud controls", desc: "Continuous monitoring across all numbers." },
  { icon: "database", title: "Data residency", desc: "Records stored in line with local requirements." },
];
...
const focusCards = [
  { icon: "target", title: "Focused product", desc: "One product, done well — local phone presence." },
  { icon: "server", title: "Group infrastructure", desc: "Backed by ZoikoNex's platform and security." },
  { icon: "trendingUp", title: "Built to scale", desc: "Designed for many markets from day one." },
];
          ...
          <div className="space-y-4">
            {trustPoints.map((t) => (
              <div key={t.title} className="flex gap-4 rounded-xl bg-[#f3efe7] p-5 dark:bg-gray-900">
                <span className="mt-0.5 flex-shrink-0 text-[#163a2e] dark:text-[#34d39e]">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {businessCards.map((c) => (
              <div key={c.title} className="rounded-2xl bg-white p-5 ring-1 ring-black/5 dark:bg-gray-800 dark:ring-white/10">
                <span className="inline-flex h-9 w-9 items-center justify-center rounded-lg bg-[#163a2e]/10 text-[#163a2e] dark:bg-[#34d39e]/10 dark:text-[#34d39e]">
      ...
      <section className="bg-white px-4 py-20 sm:px-6 lg:px-8 dark:bg-gray-800">
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <a href="/platform"><button className="mt-8 rounded-full bg-[#d9603f] px-7 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#c25030]">
              See how it works
            </button></a>
          </div>
            ...
            <div className="mt-5 space-y-3">
              {["Caller identified & verified", "Intent: new enquiry", "Routed to sales team", "Summary saved to record"].map((line) => (
                <div key={line} className="flex items-center gap-3 rounded-lg bg-white px-4 py-3 text-sm dark:bg-gray-800 dark:text-gray-100">
                  <span className="flex-shrink-0 text-[#163a2e] dark:text-[#34d39e]">
      ...
      <section className="bg-[#0f2a21] px-4 py-20 text-white sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-xl">
            ...
            <a href="/terms-of-service"><button className="mt-6 rounded-full bg-white px-7 py-3 text-sm font-semibold text-[#0f2a21] transition-colors hover:bg-white/90">
              Read compliance
            </button></a>
          </div>
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {scaleItems.map((s) => (
              <div key={s.title} className="rounded-2xl bg-white/5 p-5 ring-1 ring-white/10">
                <span className="mb-3 inline-flex text-white/80">
                  <Icon name={s.icon} className="h-5 w-5" light />
                </span>
            ...
            <div>
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                <a
                  ...
                  className="rounded-full bg-[#d9603f] px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#c25030]"
                >
                  Explore ZoikoNex
                </a>
            ...
            <ul className="space-y-3 lg:pt-10">
              {zoikonexPoints.map((p) => (
                <li key={p} className="flex items-start gap-3 text-sm text-white/80">
                  <span className="mt-0.5 flex-shrink-0 text-[#34d39e]">
                    <Icon name="check" className="h-4 w-4" />
                  </span>
                  {p}
                </li>
